...
import { setCompanyName, setCompanyEmail, setCompanyPassword, setCompanyNumber, setIsLoaded, setError } from '../../actions';
		...
		try {
			if (data['company_name'] == companyName && data['company_number'] == companyNumber) {
				...
				if (res.status === 200) {
					...
					await axios.post('http://127.0.0.1:5000/verify-business-email', { business_email: companyEmail, token: data.token });
				}
			} else {
