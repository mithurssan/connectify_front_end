  ...
  return (
    <div className="Home-page">
      ...
      <div className="image-container">
        <img className="image" src={connectifyhome} alt="Group of employees" />
      </div>
      <div className="text-list-container">
        <div className="text-container">
          <p className="image-text">
            Level up <br />your <br /> efficiency <br /> with <br /> Connectify
          </p>
        </div>
      ...
      <div className="section-background">
        ...
        <div className="centered-text">
          <p className="centered-paragraph">
            “Connectify has completely revolutionized how we work with our frontline colleagues. By enabling us to communicate freely and efficiently, it's broken down the barrier between management and the frontline, creating a vibrant and open culture that encourages us all to do our best work. ”
          </p>
          <div className="ceo-image-container">
          <img className="ceoimage" src={joanne} alt="Female CEO" />
          <figcaption className="caption">Joanne Harris |Head of Operations| | Go North West|</figcaption>
        </div>
      ...
      <div className="Internal-communication">
        ...
        <p className="Connect-feature">
          2. Internal Communication
        </p>
        <p className="Connect-subtext">
        Simpler, more effective <br/>Internal Communication
        </p>
        <div className="connect-container">
          <ul className="connect-text">
